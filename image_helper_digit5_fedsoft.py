...
class ImageHelper(Helper):
    ...
    def create_model(self,single=False):
        ...
        clients_model_list = []
        for i in range(100):
            model_p = Digit5CNN(num_input=3, num_classes=10, name='Client' + str(i),
                                created_time=self.params['current_time'])
            model_p.to(device)
            clients_model_list.append(copy.deepcopy(model_p))
        self.clients_model_list = clients_model_list
