...
class Helper:
    def __init__(self, current_time, params, name, dataname=1, single=False, divide_q=0,train=True,base_model='resnet18-cifar10'):
        self.current_time = current_time
        self.target_model = None
        self.top_model = None
        # self.target0_model = None
        # self.target1_model = None
        # self.target2_model = None
        # self.target3_model = None
        # self.target4_model = None
        # self.target5_model = None
        # self.target6_model = None
        # self.target7_model = None
        # self.target8_model = None
        # self.target9_model = None
        # self.target10_model = None
        # self.target11_model = None
        # self.target12_model = None
        # self.target13_model = None
        # self.target14_model = None
        # self.target15_model = None
        # self.target16_model = None
        # self.target17_model = None
        # self.target18_model = None
        # self.target19_model = None
        # self.target20_model = None
        # self.target21_model = None
        # self.target22_model = None
        # self.target23_model = None
        # self.target24_model = None
        # self.target25_model = None
        # self.target26_model = None
        # self.target27_model = None
        # self.target28_model = None
        # self.target29_model = None
        # self.target30_model = None
        # self.target31_model = None
        # self.target32_model = None
        # self.target33_model = None
        # self.target34_model = None
        # self.target35_model = None
        # self.target36_model = None
        # self.target37_model = None
        # self.target38_model = None
        # self.target39_model = None
        # self.target40_model = None
        # self.target41_model = None
        # self.target42_model = None
        # self.target43_model = None
        # self.target44_model = None
        # self.target45_model = None
        # self.target46_model = None
        ...
        if dataname == 1:
            if single:
                self.folder_path = f'saved_models/{base_model}_single_{divide_q}_{current_time}'
            else:
                self.folder_path = f'saved_models/{base_model}_{divide_q}_{current_time}'
        elif dataname == 2:
            if single:
                self.folder_path = f'saved_models/{base_model}_single_{divide_q}_{current_time}'
            else:
    ...
    def average_shrink_models(self, weight_accumulator, target_model,epoch,num=1,llr=1):
        """
        ...
        for name, data in target_model.state_dict().items():
            ...
            # update_per_layer = weight_accumulator[name] * llr*\
            #                    (self.params["eta"] / self.params["number_of_total_participants"])
            update_per_layer = weight_accumulator[name]*llr/num
    ...
    def save_model(self, model=None, epoch=0, val_loss=0):
        ...
        if self.params['save_model']:
            ...
            model_name = '{0}/{1}.pt.tar'.format(self.params['folder_path'], model.name)
